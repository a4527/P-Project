    ...
    public CommandLineRunner seedCampusData() {
        return args -> {
            ...
            List<BuildingSeed> seeds = List.of(
                    ...
                    new BuildingSeed("제3기숙사", "gachon_dorm3", 37.455824, 127.134942, 4),
                    new BuildingSeed("중앙도서관", "gachon_library", 37.452203, 127.133012, 5),
                    new BuildingSeed("교육대학원", "gachon_gradschool", 37.451993, 127.131813, 6));
